...
4. The project should open in IDEA. In the project structure, navigate to `src/main/java/com.kpatil.critter`. 
...
1. Within your project in IDEA, Navigate to `src/test/java/com.kpatil.critter`.
